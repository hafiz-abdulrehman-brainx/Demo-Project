...
class TrainingRecyclerAdapter(private val trainingNames:List<String>):RecyclerView.Adapter<TrainingRecyclerAdapter.MyTrainingViewHolder>() {
    ...
    inner class MyTrainingViewHolder(val binding: TrainingItemLayoutBinding
    ): RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyTrainingViewHolder {
        binding = TrainingItemLayoutBinding.inflate(LayoutInflater.from(parent.context),parent,false)
